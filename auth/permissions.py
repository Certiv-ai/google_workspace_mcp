...
SERVICE_PERMISSION_LEVELS: Dict[str, List[Tuple[str, List[str]]]] = {
    ...
    "searchconsole": [
        ("readonly", [SEARCHCONSOLE_READONLY_SCOPE]),
        # full always includes readonly because the read tools need it.
        ("full", [SEARCHCONSOLE_SCOPE, SEARCHCONSOLE_READONLY_SCOPE]),
    ],
    "appscript": [
        (
            "readonly",
